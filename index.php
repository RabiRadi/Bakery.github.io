...
<head>
    ...
    <title>Our lovely Bakery shop</title>
...
<header class="header">
    ...
    <section class="flex">
        ...
        <a href="#home" class="logo"><span>B</span>akery</a>
...
<div class="home-bg">
    ...
    <section class="home" id="home">
        ...
        <div class="slide-container">
            ...
            <div class="slide">
                <div class="image">
                    <img src="images/shop22.jpg" alt="">
                </div>
                <div class="content">
                    <h3>We will be glad to see you!</h3>
                    <div class="fas fa-angle-left" onclick="prev()"></div>
                    <div class="fas fa-angle-right" onclick="next()"></div>
                </div>
            </div>
...
<section class="features" id="features">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>We always have fresh and delicious cakes.</p>
        ...
        <div class="box">
            ...
            <h3>free delivery</h3>
            <p>You can order free home delivery from us.</p>
            <a href="#menu" class="btn">our menu</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>easy payments</h3>
            <p>You can pay for your order by card or QR.</p>
            <a href="#menu" class="btn">our menu</a>
        </div>
...
<section class="team" id="team">
    ...
    <div class="about-section">
        <div class="row">
            <div class="column">
                <div class="card">
                    <img src="images/ава6.png" alt="Jane" style="width:100%">
                    <div class="container">
                        <h2>Rabiga Radikova</h2>
                        <p class="title">WEB Designer</p>
                        <p>rabiga@gmail.com</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card">
                    <img src="images/ава5.png" alt="Mike" style="width:100%">
                    <div class="container">
                        <h2>Sanzhar Mustafa</h2>
                        <p class="title">WEB Designer</p>
                        <p>sanzhar@gmail.com</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card">
                    <img src="images/ава7.png" alt="John" style="width:100%">
                    <div class="container">
                        <h2>Lailym Omirbek</h2>
                        <p class="title">WEB Designer</p>
                        <p>lailym@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
